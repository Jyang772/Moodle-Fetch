...
//void Download_PDF(CURL*, CURLcode);
...
int main(void)
{
	...
	CURLcode res;
	string contents;
	string line = "http://moodle.redlands.edu/course/view.php?id=2213";
	char *result = strdup(line.c_str());
	string name_before = "Assignment #";
	name_before += count;
	name_before += ".pdf";
	char *name = strdup(name_before.c_str());
	struct FtpFile ftpfile = {
...
/*cout << "Found: " << found << endl;
						cout << "Reform: " << reform_find << endl;
						cout << link << endl;
						cout << endl << "CONTENTS2: " << contents << endl;*/
...
//	contents = "http://moodle.redlands.edu/mod/resource/view.php?id=108540\"123http://moodle.redlands.edu/mod/resource/view.php?id=10\" ";
